...
jest
  .spyOn(require("express").response, "render")
  .mockImplementation(function (view, options) {
...
beforeAll(() => {
  jest.isolateModules(() => {
    ...
    jest.mock("../../config/database", () => ({
      prisma: require("../__mocks__/prisma.js"),
    }));

    // Mock fs (override unlinkSync)
    jest.mock("fs", () => {
    ...
    // require app dan model dari root (naik 2 level)
    ({ app } = require("../../app.js"));
